...
CREATE TABLE `commandes` (
  ...
  `mode_expedition_id` bigint NOT NULL,
  ...
  CONSTRAINT `fk_factures_mode_expedition1` FOREIGN KEY (`mode_expedition_id`) REFERENCES `mode_expeditions` (`id`),
  CONSTRAINT `fk_factures_mode_paiement1` FOREIGN KEY (`mode_paiement_id`) REFERENCES `mode_paiements` (`id`)
...
CREATE TABLE `images` (
  ...
  CONSTRAINT `fk_images_voiture1` FOREIGN KEY (`voiture_id`) REFERENCES `voitures` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-11-29 11:06:36
