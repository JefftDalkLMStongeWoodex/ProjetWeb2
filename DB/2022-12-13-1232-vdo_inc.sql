...
INSERT INTO `groupe_motopropulseurs` VALUES (1,'2 roues motrices','two-wheel drive'),(2,'4 roues motrices','four-wheel drive'),(3,'traction arrière','rear-wheel drive'),(4,'traction avant','front-wheel drive'),(5,'traction intégrale','all-wheel drive');
...
INSERT INTO `images` VALUES (3,NULL,NULL,'images/1tATpvId5TUZxsVd7tgB3KigN1NbPHks8RMBNaMd.png',NULL,NULL,0,2,'2022-12-11 03:03:55','2022-12-11 03:03:55'),(4,'test nom fichier','test filename','images/voiture_21670712912','alt nom fichier','alt file name',1,2,'2022-12-11 03:55:12','2022-12-11 03:55:12'),(5,'image principale tiguan','main image tiguan','images/voiture_3_1670896739','image principale tiguan','main image tiguan',1,3,'2022-12-13 06:58:59','2022-12-13 06:58:59'),(6,'test','test','images/voiture_7_1670898147','test','test',1,7,'2022-12-13 07:22:27','2022-12-13 07:22:27');
...
INSERT INTO `password_resets` VALUES ('stng.mathieu@gmail.com','$2y$10$FRhY4sn44Y5sn8OwycfgN.yoYl7YEidyEb0vEueOsj4NcEQc2AElK','2022-12-03 05:54:40');
...
INSERT INTO `statut_voitures` VALUES (1,'Disponible','Available'),(2,'Réservée','Reserved'),(3,'Vendue','Sold'),(4,'Expédiée','Shipped');
...
INSERT INTO `users` VALUES (2,'St-Onge','Mathieu','stng.mathieu@gmail.com',NULL,'$2y$10$7dqF9.4VNwhBe5nDDrkUpuo2E2bI/kWmeW7CEtnWE4Jdr.RMffiaK',NULL,'4234','234234','2342342',NULL,'kD6Zco3T2jzvVSECRYcGJ0xzpNPMm6gnzCt6s6XZH4MMtwgU0ZKQJMAWn5yS',NULL,NULL,3,1),(3,'Sanches','Marcos','admin@gmail.com',NULL,'$2y$10$ke.H1yYzv7K1LQBJgSrd.uesUaxBNm1M683ccEQVjLFulOIUfku3.','1111-11-11','111','h1h1h1','(111) 111-1111','(111) 111-1111',NULL,'2022-12-03 06:14:05','2022-12-03 06:14:05',3,1);
...
CREATE TABLE `voitures` (
  ...
  `commandes_id` bigint DEFAULT NULL,
  `statut_voitures_id` bigint NOT NULL,
  `etats_id` bigint NOT NULL,
  `reservation_users_id` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `voitures` VALUES (2,1902,'2022-12-08',2000,5,'Une voiture comme on n\'en fait plus, en français à part de ça','What a great car!',NULL,3,1,1,1,2,NULL,1,2,2,NULL,'2022-12-12 21:11:55'),(3,1901,'2022-12-01',2000,121212,NULL,NULL,NULL,1,2,1,2,1,NULL,1,1,NULL,'2022-12-06 03:41:42','2022-12-06 03:41:42'),(7,2021,'2022-12-12',100100,11111,'francais','anglais',NULL,3,7,1,1,1,NULL,1,1,NULL,'2022-12-07 01:30:27','2022-12-07 01:38:11'),(8,2020,'2022-12-01',5000,50000,'Le char préféré à Lukas','Lukas\' favorite car',NULL,8,3,2,2,1,NULL,1,1,3,'2022-12-07 01:40:05','2022-12-13 06:55:12'),(9,2022,'2022-12-06',0,5,'fr','en',NULL,2,2,1,2,2,NULL,1,2,2,'2022-12-10 02:27:51','2022-12-13 06:55:27');
...
-- Dump completed on 2022-12-13 12:32:50
